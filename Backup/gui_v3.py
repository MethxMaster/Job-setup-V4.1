...
output_folder_str = os.getcwd() + '\\output'


class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(1139, 541)
        ...
        self.GetDate_DateInfo_label.setText(current_time.strftime("%d %B %Y"))
        ...
        self.OutputDirectory_OutputLocation_lineEdit.setText(os.getcwd() + '\\output\\' + current_time.strftime("%Y-%m-%d"))
        ...
        self.Information_frame = QtWidgets.QFrame(self.MainWindow_frame)
        self.Information_frame.setGeometry(QtCore.QRect(10, 390, 491, 61))
        ...
        self.layoutWidget2 = QtWidgets.QWidget(self.Information_frame)
        ...
        self.InputXMLDirectory_InputXMLLocation_lineEdit_3.setText("")
    ...
    def execution(self):
        ...
        if created_folder == True :
            ex_func.log_text = 'folder location : ' + os.getcwd() + '/' + str(check_directory) + ' was created'
            ex_func.notification(log_text)
        ...
        xml_file = handling_file.handling_file(all_file_name,check_directory)
        ...
        write_form.write_from(first_batt,all_file_name,check_directory,date_string)
